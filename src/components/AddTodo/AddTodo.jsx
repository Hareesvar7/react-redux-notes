...
const AddTodo = () => {
  ...
  const dispatch = useDispatch();
    ...
    const submitTodo = (e) => {
      ...
      if (!todoText.trim()) {
        alert('Please fill in your Note')
      }
  ...
  return (
    <section className={classes.section}>
      <form onSubmit={submitTodo}>
        <div>
    		  <Input value={todoText}  type="text" placeholder="Enter Your Note" getTodo={getTodoText} />
        ...
        <div className={classes.reminder__label}>
          ...
          <label htmlFor="reminder">Set reminder for this Note</label>
        </div>
      </form>
    </section>
  )
